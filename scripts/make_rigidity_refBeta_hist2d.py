...
def main():
    ...
    if usetunedRICH == True:
        np.savez(os.path.join(args.resultdir, f"{nuclei}_tofbetaResidual_ref{decref}_beta2Tuned_B1236P8mcweight.npz"), **result_resolution)
    else:
        np.savez(os.path.join(args.resultdir, f"{nuclei}_tofbetaResidual_ref{decref}_beta2_B1236P8mcweight.npz"), **result_resolution)
