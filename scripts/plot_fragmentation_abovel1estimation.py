...
def main():
    ...
    file_names = {"B10": "/home/manbing/Documents/Data/data_effacc/annflux/B10MC_anaflux.root",
                  "B11": "/home/manbing/Documents/Data/data_effacc/annflux/B11MC_anaflux.root",
                  "C12": "/home/manbing/Documents/Data/data_effacc/annflux/C12MC_anaflux.root",
                  "N14": "/home/manbing/Documents/Data/data_effacc/annflux/N14MC_anaflux.root",
                  "N15": "/home/manbing/Documents/Data/data_effacc/annflux/N15MC_anaflux.root",
                  "O16": "/home/manbing/Documents/Data/data_effacc/annflux/O16MC_anaflux.root"}
    ...
    spline_bkg_abovel1_total = UnivariateSpline(np.log(rig_binning.bin_centers[5:-2]), bkg_abovel1_total[4:-1], k=3, s=100)
    yfit_bkg = spline_bkg_abovel1_total(np.log(rig_binning.bin_centers[1:-1]))
    
    ax1.plot(rig_binning.bin_centers[1:-1], yfit_bkg, "--", color="black", linewidth=3, label="Total")
    ...
    spline_bkg_abovel1_total_clean = UnivariateSpline(np.log(rig_binning.bin_centers[2:-2]), bkg_abovel1_total_clean[1:-1], k=3, s=100)
    ...
    for i, i_nuclei in enumerate(nuclei):
        ...
        #ax1.plot(rig_binning.bin_centers[1:-1], bkg_stackup, ".", markersize=18, color=COLOR_NUCLEI[i_nuclei])
        spline_bkg_stackup_clean = UnivariateSpline(np.log(rig_binning.bin_centers[5:-2]), bkg_stackup_clean[4:-1], k=3, s=10)
    ...
    ax1.legend(fontsize=FONTSIZE)
    ax1.set_ylabel(r"$\mathrm{(1-R_{den})/(1-R_{num})}$", fontsize=FONTSIZE)
    ax1.set_xlabel(r"$\mathrm{Rigidity (GV)}$", fontsize=FONTSIZE)
