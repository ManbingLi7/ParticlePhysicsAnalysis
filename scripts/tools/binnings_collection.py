...
def LithiumBetaBinning():
    LithiumRichAglBetaBinning = np.array([0.95,  0.95786,  0.962209,  0.96483,  0.967, 
                                                    0.968977,  0.97104,  0.97334,  0.975972,  
                                                    0.978944,  0.982383,  0.986508,  0.991324,  0.99692, 1.0069, 1.02])
...
def fbinning_energy_Li():
    binning = np.array([0.261, 0.338, 4.0615e-01,  4.9094e-01, 5.8761e-01, 6.9636e-01, 8.2148e-01 , 9.5893e-01 ,1.1130e+00 ,1.2839e+00 , 1.4714e+00 , 1.6803e+00 , 1.9105e+00 , 2.1621e+00 , 2.4349, 2.7338e+00, 3.0588e+00 , 3.4096e+00 , 3.7913e+00 , 4.2037e+00 , 4.6468e+00 , 5.1404e+00 , 5.6349e+00 , 6.1798e+00 , 6.7750e+00 , 7.4206e+00 , 8.1166e+00 , 8.8629e+00 , 9.6595e+00 , 1.0506e+01, 1.1454e+01])    
    return binning
...
def kinetic_energy_neculeon_binning():
    energy_per_neculeon_binning = np.array([0.267027, 0.332288, 0.405434, 0.490126, 0.586704, 0.695356, 0.820378, 0.957741, 1.11175, 
                                            ...
                                            13.4964, 14.6442, 15.8422, 17.1403, 18.5386, 20.037, 21.6355, 23.3341, 25.1829, 27.1317, 29.2306, 40.4796, 100, 300])
    return energy_per_neculeon_binning
...
def fbinning_inversemass(nuclei):
    inverse_mass_binning = {'Li': np.linspace(0.03, 0.35, 220), 'Be':  np.linspace(0.03, 0.3, 150), 'B': np.linspace(0.03, 0.2, 200), 'O': np.linspace(0.03, 0.2, 300), 'C': np.linspace(0.03, 0.2, 300)}
