...
class ResolutionFunction(metaclass=abc.ABCMeta):
    def __init__(self, isotope, hist_data, fit_energy_range, detector, component="All"):
        ...
        #self.resofunction = self.make_mass_function_simultaneous()
