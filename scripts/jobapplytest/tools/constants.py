...
ISOTOPES_MASS = {"Li6": 5.60305, "Li7": 6.53536, 
                 ...
                 'B10': 9.32699, 'B11':10.25510, 'C12': 11.17793, 'O16': 14.931}
#ISOTOPES_MASS = {"Be7": 6.53622, "Be9": 8.39479, "Be10":9.32699, 'B10': 9.32699, 'B11':10.25510, 'C12': 11.17793}
ISOTOPES_COLOR = {"Li6": "tab:blue", "Li7":"tab:orange", "Be7": "tab:blue", "Be9": "tab:orange", "Be10": "tab:green", "B10":"tab:blue", "B11":"tab:orange"}
NUCLEI_NUMBER =  {"Li6": 6, "Li7": 7, "Be7":7, "Be9":9, "Be10":10, "B10": 10, "B11": 11, "C12":12, "C13": 13}
...
ANALYSIS_RANGE_RIG = {"Li": {"Tof": [1.92, 3.2], "NaF": [2.926, 10.0], "Agl": [8.33, 23.0]},
                         "Be": {"Tof": [1.92, 4.54], "NaF": [2.926, 14.0], "Agl": [8.33, 33.0]}, #Min for Be7, Max for Be10
                         "B": {"Tof": [1.92, 5.0], "NaF": [2.926, 15.5], "Agl": [8.33, 37.0]}}
...
DETECTOR_COLOR = {"Tof": "tab:orange", "NaF": "tab:blue", "Agl": "tab:green"}
ISO_LABELS = {"C12": "$\mathrm{^{12}C}$", "He4": "$\mathrm{^{4}He}$",
              ...
              'B10': "$\mathrm{^{10}B}$", 'B11': "$\mathrm{^{11}B}$"}
...
CUTOFF_FACTOR = {'Be7': 1.0 , 'Be9': 0.8, 'Be10': 0.6, "Li6": 1.0, "Li7": 0.8, "B10": 1.0, "B11": 0.8}
