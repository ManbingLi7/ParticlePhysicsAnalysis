...
def plot_fitdata_pars(parname, detectors, massfit, fit_parameters, init_parameters, polypars_initp0, ylabel, yrange, nuclei, plotdir, guess_initial, plot_mc=True, plot_guess=False, figname=None):
