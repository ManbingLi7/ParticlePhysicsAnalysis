...
class NaFInverseMassFunctionFit(InverseMassFunctionFit):
    ...
    def make_mass_function_simultaneous(self, drawiso="All"):
        ...
        def mass_function(x, *pars):
            ...
            #scale_factors_mean = np.array([1.0, 0.78009693, 0.70348614])
            ...
            for i, n in enumerate(norm):
                ...
                coregaus = gaussian(mass, mean * isofactor, sigma * scaling_sigma)
                asygaus = asy_gaussian(mass, mean * isofactor,  sigma_ratio * sigma * scaling_sigma, asy_factor)
