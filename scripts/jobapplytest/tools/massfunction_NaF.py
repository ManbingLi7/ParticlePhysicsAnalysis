...
class NaFInverseMassFunctionFit(InverseMassFunctionFit):
    ...
    def make_mass_function_simultaneous(self, drawiso="All"):
        ...
        def mass_function(x, *pars):
            ...
            #scale_factors_mean = np.array([1.0, 0.77992301, 0.70332683])
            scaling_factor_sigma = np.array([1.0, 0.78405235, 0.7075704])
            scale_factors_mean = {"Be9": np.array([7.81500116e-01, -1.93436251e-03,  4.51808624e-04]),
                                  "Be10": np.array([0.70613437, -0.00479914,  0.00203857])} 
            for i, n in enumerate(norm):
                ...
                #scaling_sigma = scaling_factor_sigma[i]
                #scaling_mean = scale_factors_mean[i]                
