...
def plot_fitdata_pars(parname, detectors, massfit, fit_parameters, polypars_initp0, ylabel, yrange, nuclei, plotdir, guess_initial, plot_mc=False, plot_guess=True, figname=None):
    parname_s = {'Tof': {'mean': 'mua', 'sigma':'siga' , 'fraccore': 'fraccore', 'asy_factor': 'asy_factor_a', 'sigma_ratio': 'sigma_ratio_a'},
                 ...
                 'Agl': {'mean': 'mua', 'sigma':'siga' , 'fraccore': 'fraccore', 'asy_factor': 'asy_factor_a', 'sigma_ratio': 'sigma_ratio_a'}}
