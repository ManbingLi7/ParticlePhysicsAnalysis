...
############################################################
df_highRPars = np.load('/home/manbing/Documents/lithiumanalysis/scripts/tools/corrections/graph_pars_RICH_HighR.npz')
graph_diff_mean = {}
graph_ratio_sigma = {}
for dec in ['NaF', 'Agl']:
...
def GetMCTunedBeta_WithHighR(events, beta, dec, iso):
    ...
    beta_tuned = mean_shift + (beta - true_beta_atRICH) * sigma_scale + true_beta_atRICH
    return beta_tuned
############################################################
