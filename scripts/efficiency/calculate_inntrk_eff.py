...
color_cut = {"l1q": "magenta",
             "tof": "tab:blue",
             "inntof": "tab:orange",
             "inncutoff": "tab:orange",
             "pk": "brown",
             "bz": "tab:red",
             "trigger": "green",
             "total": "black"}
...
cutname = {"l1q": "L1 unbiased charge",
           "tof": "Tof charge",
           "inntof": "Inner Track(Rtof)",
           "inncutoff": "Inner Track(Rcutoff)",
           "pk": "L1 picking up",
           "bz" : "L1 big charge",
           "trigger": "trigger"}
...
def plot_graph_eff(figure, plot, graph_eff, isotope=None, legend=None, col=None):
    plot1d_errorbar_v2(figure, plot,  graph_eff.getx(), graph_eff.gety(), err=graph_eff.get_yerrors(), label_x="Rigidity", label_y="Efficiency", setlogx=True, label=legend if legend is not None else f'{isotope}', color=color_iso[isotope] if col is None else col)
