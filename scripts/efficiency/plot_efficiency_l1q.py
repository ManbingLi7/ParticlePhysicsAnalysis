...
def main():
    ...
    spline_l1q_eff = get_spline_from_file("/home/manbing/Documents/lithiumanalysis/scripts/plots/effcor/l1q/spline_l1q_eff_2.pickle", "spline_l1q_eff")
    print(spline_l1q_eff(np.log(kNucleiBinsRebin_center)))
    polyfit_l1q_eff = get_nppolyfit(np.log(kNucleiBinsRebin_center), spline_l1q_eff(np.log(kNucleiBinsRebin_center)), 2)
    ...
    print(len(graph_lq_jiahui.getx()), len(graph_lq_jiahui.gety()), len(graph_lq_jiahui.get_yerrors()))
    ...
    ployfit_pars  = getpars_curvefit_poly(graph_bz, 4)
    ...
    ax1.plot(graph_bz.xvalues, eff_cor_bz_jw(np.log(graph_bz.xvalues)), "-", color="grey")
