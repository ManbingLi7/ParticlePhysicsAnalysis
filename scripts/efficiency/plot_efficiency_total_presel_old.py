...
def main():
    ...
    parser.add_argument("--datadir", default="/home/manbing/Documents/Data/data_BeP8/efficiency/spline_effcor", help="dataname for the output file and plots.")
    ...
    #Tof
    figure, ax1 = plt.subplots(1, 1, figsize=(22, 11))
    ...
    ax1.plot(kNucleiBinsRebin_center, sedtrk_effcor, "-", color="grey", label="Background")
    ...
    ax1.set_xscale("log")
    ax1.set_xlim([1.8, 100])
    ax1.set_xticks([2, 5,  10, 20, 50, 100])
    ax1.get_xaxis().set_major_formatter(matplotlib.ticker.ScalarFormatter())
    ax1.get_yticklabels()[0].set_visible(False)
    ...
    savefig_tofile(figure, args.resultdir, f"hist_total_effcor_presel", show=True)
    
    plt.show()
    np.savez(os.path.join(args.datadir, f"graph_total_effcor_presel.npz"), **dict_total_effcor)  
