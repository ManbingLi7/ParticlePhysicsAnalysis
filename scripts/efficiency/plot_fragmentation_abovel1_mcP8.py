...
def main():
    ...
    parser.add_argument("--resultdir", default="plots/effcor/bkg", help="Directory to store plots and result files in.")
    ...
    znum = 'z4'
    file_name_iss = "/home/manbing/Documents/Data/data_effacc/annflux/BeISS_anaflux.root"
    ...
    #file_names = {iso : f'/home/manbing/Documents/Data/data_effacc/annflux/B10MC_anaflux.root' for iso in fragment_nuclei.keys()}
    file_names = {iso : f'/home/manbing/Documents/Data/data_effacc/annflux/{iso}MC_anaflux.root' for iso in fragment_nuclei.keys()}
    
    file_flux_qy = {"Be7": '/home/manbing/Documents/Data/data_flux_qy/beryllium64_20200420V2N_B1219401R4MCKY10COMBUNFOLDTOINB_totalQYAN.root',
                    ...
                    "C12": '/home/manbing/Documents/Data/data_flux_qy/carbon64_20200420V2N_B1215401R4MCKY10COMBUNFOLDTOINB_totalQYAN.root',
